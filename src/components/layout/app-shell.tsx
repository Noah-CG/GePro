 ...
 * Au-dessus du contenu, la barre d'onglets de GePro.
 */
export function AppShell({ sidebar, prefs, children }: { sidebar: SidebarData; prefs: SidebarPrefs; children: ReactNode }) {
