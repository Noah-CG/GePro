/**
 * Migration 0011_isolation_projets sur des données d'avant l'isolation : propriétaires, membres,
...
const MIGRATION = readFileSync("drizzle/0011_isolation_projets.sql", "utf8");
const ROLLBACK = readFileSync("scripts/rollback/0011_isolation_projets.sql", "utf8");
...
beforeAll(async () => {
  ...
  journal.entries = journal.entries.filter((e) => e.tag !== "0011_isolation_projets");
...
describe("migration 0011_isolation_projets", () => {
