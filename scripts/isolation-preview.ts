/**
 * Aperçu de la migration 0012_isolation_projets, en LECTURE SEULE : propriétaire et membres prévus
 * pour chaque projet, événements d'équipe à rattacher. Mêmes règles que drizzle/0012_isolation_projets.sql.
 *
