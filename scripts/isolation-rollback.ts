/**
 * Retour arrière de la migration 0011_isolation_projets (voir scripts/rollback/0011_isolation_projets.sql).
 *
...
async function main() {
  ...
  const script = readFileSync("scripts/rollback/0011_isolation_projets.sql", "utf8");
